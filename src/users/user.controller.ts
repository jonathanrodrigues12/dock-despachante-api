...
export class UserController {
  ...
  async createUser(
    ...
    return this.userService.create(createUserDto, requestBy, photo);
  }
  ...
  async updateUser(
    ...
    return this.userService.update(id, updateUserDto, requestBy, photo);
  }

  @ApiOperation({
    summary: 'Check if email exists in use',
  })
  @ApiOkResponse({
    description: 'Check if email exists in use',
    type: Boolean,
  })
  @Get('check/:email')
